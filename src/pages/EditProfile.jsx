        ...
        <main className="flex-1 flex flex-col items-center pt-8 pb-20 px-4">
          <div className="w-full max-w-[460px]">
            ...
            <div className="mb-10 flex flex-col items-center">
              <div className="relative group cursor-pointer" onClick={() => imgInputRef.current?.click()} id="editProfileImgContainer">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* same fields as create account but prefilled */}
